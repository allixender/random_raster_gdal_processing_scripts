...
fh = logging.FileHandler('script_output-para_stats_tree_cover.log')
...
def calculate_for_feature(featureid: str, year: int) -> Dict:
    ...
    folder = "../tree_cover_30_{}".format(year)
    raster = os.path.join(folder, "tree_cover_c2_tile_{}.tif".format(featureid))
...
if __name__ == '__main__':
    ...
    for year in range(2000,2018,1):
        ...
        df.to_csv('lc-stats_tree_cover_per_year_{}.csv'.format(year), sep=';')
