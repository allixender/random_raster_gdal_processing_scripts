...
fh = logging.FileHandler('script_output-cut_treecover_2012_wgain.log')
...
def cut_line(featureid: str, maintiff: str, year: int) -> str:
    ...
    gdal_cmd = "gdalwarp -cutline ../vector_tiles/{}.shp -crop_to_cutline {} ../tree_cover_30_wgain_{}/tree_cover_c2_tile_wgain_{}.tif".format(
...
if __name__ == '__main__':
    ...
    for year in range(2012, 2018, 1):
        ...
        start=datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        rasterfile="../tree_cover_30_wgain_{}.tif".format(year)
        logger.info(
